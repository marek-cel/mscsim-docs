...
set output "../xfoil_naca0012_cz.eps"
...
plot \
  "../csv/NACA_0012_XFOIL.csv" using 1:2 with linespoints ls 1 title "XFOIL", \
  "../csv/NACA_0012_TN-3361.csv" using 1:2 with linespoints ls 2 title "[Critzos, et al., NACA TN-3361, 1951]", \
  "../csv/NACA_0012_Sheldahl.csv" using 1:2 with linespoints ls 3 title "[Sheldahl, Klimas, 1981]"
