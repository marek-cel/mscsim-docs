...
\begin{codelistbash}
  \lstinputlisting{src/terrain_BMNG_elev.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_BMNG_land.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_Landsat_extract.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_Landsat_merge_1.sh}
\end{codelistbash}

\texttt{merger} can be used to merge separate bands to true-color image.

\begin{codelistbash}
  \lstinputlisting{src/terrain_Landsat_merge_2.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_Landsat_reproject.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_Landsat_tiles_merge.sh}
\end{codelistbash}

\texttt{gdal\_translate} can be used to convert merged image to GeoTIFF.

\begin{codelistbash}
  \lstinputlisting{src/terrain_Landsat_convert.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_HiResOrtho_extract.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_HiResOrtho_scale.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_HiResOrtho_merge.sh}
\end{codelistbash}

\texttt{gdal\_translate} can be used to convert merged image to GeoTIFF.

\begin{codelistbash}
  \lstinputlisting{src/terrain_HiResOrtho_convert.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_HiResOrtho_reproject.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_VMAP0_create.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_VMAP0_rasterize.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_VMAP0_convert.sh}
\end{codelistbash}
...
\begin{codelistbash}
  \lstinputlisting{src/terrain_VPB_generate.sh}
\end{codelistbash}

\subsection{Patching Textures}

\begin{codelistbash}
  \lstinputlisting{src/terrain_VPB_patch_tex.sh}
\end{codelistbash}

\subsection{Patching Elevation}

\begin{codelistbash}
  \lstinputlisting{src/terrain_VPB_patch_dem.sh}
\end{codelistbash}
