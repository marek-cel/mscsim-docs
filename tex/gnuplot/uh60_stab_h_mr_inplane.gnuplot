...
set output "../eps/uh60_stab_h_mr_inplane.eps"
set xlabel "Rotor Wake Skew Angle [deg]"
set ylabel "Main Rotor Inplane Wash at the Horizontal Tail [-]"
...
plot \
  "../csv/uh60_stab_h_mr_inplane.csv" using 1:2 with linespoints ls 1 title "AA1FMR=-6.0", \
  "../csv/uh60_stab_h_mr_inplane.csv" using 1:3 with linespoints ls 2 title "AA1FMR=0.0", \
  "../csv/uh60_stab_h_mr_inplane.csv" using 1:4 with linespoints ls 3 title "AA1FMR=6.0"
