...
set output "../eps/xfoil_naca0012_cm.eps"
...
plot \
  "../csv/aero_NACA_0012_XFOIL.csv" using 1:4 with linespoints ls 1 title "XFOIL", \
  "../csv/aero_NACA_0012_TN-3361.csv" using 1:4 with linespoints ls 2 title "[NACA-TN-3361]"
