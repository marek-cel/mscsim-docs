...
plot \
  "../csv/xfoil_out_sc1095.csv" using 1:3 with linespoints ls 1 title "XFOIL", \
  "../csv/SC1095_CR-166309_cx.csv" using 1:4 with linespoints ls 2 title "[NASA-CR-166309]" , \
  "../csv/SC1095_TM-86719.csv" using 1:3 with linespoints ls 3 title "[NASA-TM-86719]"
