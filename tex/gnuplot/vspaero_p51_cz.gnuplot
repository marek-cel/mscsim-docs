...
set output "../eps/vspaero_p51_cz.eps"
...
plot \
  "../csv/p51_vspaero.csv" using 1:2 with linespoints ls 1 title "VSPAERO", \
  "../csv/p51_openfoam.csv" using 1:4 with linespoints ls 2 title "OpenFOAM"
