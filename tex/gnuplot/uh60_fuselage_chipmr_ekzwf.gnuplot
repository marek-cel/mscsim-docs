...
set output "../eps/uh60_fuselage_chipmr_ekzwf.eps"
...
plot \
  "../csv/uh60_fuselage_chipmr_ekzwf.csv" using 1:2 with linespoints ls 1 title "AA1FMR=-6.0", \
  "../csv/uh60_fuselage_chipmr_ekzwf.csv" using 1:3 with linespoints ls 2 title "AA1FMR=0.0", \
  "../csv/uh60_fuselage_chipmr_ekzwf.csv" using 1:4 with linespoints ls 3 title "AA1FMR=6.0"
