...
set output "../eps/uh60_fuselage_alfwf_mqfmp.eps"
set xlabel "ALFWF {/Symbol a}_{WF} [deg]"
set ylabel "Pitching Moment M/q [m^3]"
set xrange [-90: 90]
...
plot \
  "../csv/uh60_aero_fuselage_alfwf.csv" using 1:4 with linespoints ls 1 notitle
